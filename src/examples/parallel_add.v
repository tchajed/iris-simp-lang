...
Section proof.
  ...
  Proof using All.
    ...
    { iExists 0, 0. iFrame. }
    wp_apply (wp_par (λ _, ghost_var γ1 (1/2) 2%Z) (λ _, ghost_var γ2 (1/2) 2%Z)
                with "[Hγ1] [Hγ2]").
    - iInv "Hinv" as (n1 n2) ">(Hr & Hγ1● & Hγ2●)".
      wp_apply (wp_faa with "Hr"); iIntros "Hr".
      iDestruct (ghost_var_agree with "Hγ1● Hγ1") as %->.
      iMod (ghost_var_update_halves 2%Z with "Hγ1● Hγ1") as "[Hγ1● Hγ1]".
      iModIntro.
      iFrame. iNext. iExists _, _; iFrame.
      replace (0 + n2 + 2)%Z with (2 + n2)%Z by lia; done.
    - iInv "Hinv" as (n1 n2) ">(Hr & Hγ1● & Hγ2●)".
      wp_apply (wp_faa with "Hr"); iIntros "Hr".
      iDestruct (ghost_var_agree with "Hγ2● Hγ2") as %->.
      iMod (ghost_var_update_halves 2%Z with "Hγ2● Hγ2") as "[Hγ2● Hγ2]".
      iModIntro.
      iFrame. iNext. iExists _, _; iFrame.
      replace (n1 + 0)%Z with n1%Z by lia; done.
